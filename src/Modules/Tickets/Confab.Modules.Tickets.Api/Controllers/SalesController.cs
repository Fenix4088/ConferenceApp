...
internal class SalesController(ITicketSaleService ticketSaleService) : BaseController
{
    private readonly ITicketSaleService _ticketSaleService = ticketSaleService;
